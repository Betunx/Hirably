  ...
  theme: {
    extend: {
      colors: {
        ...
        // STEP COLORS (The Hirably Way)
        'step-01': '#c2e7ff',          // Light Sky Blue
        'step-02': '#d1f9e5',          // Mint Green
        'step-02-alt': '#d1fae5',      // Mint Green alternativo
        'step-03': '#e3e1ff',          // Lavender

        // ACCENT COLORS
        'sky-blue': '#bbe2fd',         // Backgrounds suaves
        'light-sky': '#c2e7ff',        // Step 01
        'mint-green': '#d1f9e5',       // Step 02
        'lavender': '#e3e1ff',         // Step 03
        'emerald': '#10b981',          // Success, checks
        'emerald-alt': '#179c4c',      // Verde alternativo
        'purple-accent': '#6c59d8',    // Badge morado (Recruitment)
        'error-red': '#ff5656',        // Errores
