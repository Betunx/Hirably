// ── Contact Form — Types, Interfaces & Static Configuration ──────────────────
// Extracted from contact-form.component.ts to keep the component focused on logic.

export type ContactFormType = 'book-a-call' | 'start-hiring' | 'eor-services' | 'get-a-quote';
export const VALID_TYPES: ContactFormType[] = ['book-a-call', 'start-hiring', 'eor-services', 'get-a-quote'];
...
export const FORM_CONFIGS: Record<ContactFormType, ContactFormConfig> = {
